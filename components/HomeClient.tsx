    ...
    <main className="min-h-[100svh] bg-deep text-white pb-16 page-layer">
      <div className="container pt-6 px-5 stack">
        ...
        <section className="glass glass-pad relative overflow-hidden bg-[#0b0f18]/70">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-[220px_auto_160px]">
            ...
            <div className="flex items-end gap-3">
              <button type="button" onClick={handleMint} disabled={busy || pending} className="btn-pill btn-pill--blue !font-bold" style={{ opacity: busy || pending ? 0.7 : 1 }}>
        ...
        <section className="glass glass-pad bg-[#0b0f18]/70">
          ...
          <div className="mt-4 grid gap-3">
            ...
            {!recent?.length && !recentErr && (
              <div className="rounded-xl border border-white/10 bg-white/5 px-4 py-5 text-white/70">No recent mints found.</div>
            )}
          </div>
        ...
        <section className="flex flex-wrap gap-3 justify-center">
          <Link href="https://basescan.org/" target="_blank" rel="noopener noreferrer" className="pill-note pill-note--blue">Chain: Base ↗</Link>
